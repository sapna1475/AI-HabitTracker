...
export const weeklyReport = async (req , res ) => {
    try{
        ...
        //if no habit then a msg and no ai call
        ...
        const userMsg = `Here is the user's habit data for the past 7 days (${ctx.days[0]} to ${ctx.days[6]}):\\n\n${ctx.perHabit
            ...
            .join("\n")}\n\nPlease write the personalized report now.`;
...
export const suggestHabits = async (req , res) => {
    try{
        ...
        if(!suggestions.length) {
            ...
            suggestions = [
                {
                    name : "10-min morning walk",
                    description : "Start the day with little movement and fresh air.",
                    frequency: "daily",
                    category: "Fitness",
                    icon: "🚶‍♂️‍➡️",
                ...
                {
                    name : "read 5 pages",
                    description: "Short daily reading.",
                    frequency: "daily",
                    category: "Learning",
                    icon: "📚",
                ...
                },
                {
                    ...
                    icon: "🧘",
                    reason: "Helps improve focus and reduce stress."
                },
            ];
        }
        await AIInsight.create({
